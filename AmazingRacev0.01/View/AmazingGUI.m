    ...
    methods
        function obj = AmazingGUI()
            ...
            obj.h_bdir = uicontrol('Style', 'pushbutton', ...
                ...
                'Units', 'normalized', ...
                'Position', [0.275, 0.9, 0.35, 0.1], ...
                'Parent', obj.dir_tag);
            
            obj.h_bcfg = uicontrol('Style', 'pushbutton', ...
                'String', 'Load Config File', ...
                'Units', 'normalized', ...
                'Position', [0.65, 0.9, 0.35, 0.1], ...
                'Parent', obj.dir_tag);
            ...
            obj.h_breload = uicontrol('Style', 'pushbutton', ...
                'Tag', 'LoadData',...
                'String', 'Load', ...
                'Units', 'normalized', ...
            ...
            obj.h_baddstat = uicontrol('Style', 'pushbutton', ...
                'Tag', 'AddStat',...
                'String', 'Add Stat', ...
                'Units', 'normalized', ...
                'Position', [0.65, 0.74, 0.15, 0.1], ...
                'Parent', obj.stat_tag);
            
            obj.h_bremovestat = uicontrol('Style', 'pushbutton', ...
                'Tag', 'RemoveStat',...
                'String', 'Remove Stat', ...
                'Units', 'normalized', ...
                'Position', [0.65, 0.63, 0.15, 0.1], ...
                'Parent', obj.stat_tag);
            
            obj.h_estatcolumn = uicontrol('Style', 'edit', ...
                'Tag', 'SaveData',...
                'String', '-1', ...
                'Units', 'normalized', ...
                'Position', [0.81, 0.63, 0.15, 0.1], ...
                'Parent', obj.stat_tag);
        end
    end
end